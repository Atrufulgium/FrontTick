@rem Compiles ./MCMirror/* to ./MCMirror.dll
...
dotnet build .\MCMirror\MCMirror.csproj --no-dependencies --no-incremental --no-self-contained --property:OutputPath=.\build-temp --property:Version=0.0.0.1
copy /Y .\MCMirror\build-temp\MCMirror.dll .\MCMirror.dll
echo Y | rmdir /S .\MCMirror\build-temp
